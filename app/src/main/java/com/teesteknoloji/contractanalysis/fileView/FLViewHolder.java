package com.teesteknoloji.contractanalysis.fileView;
        ...
        this.itemLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( adapter.multiSelect ){
                    ...
                    Uri sharedFileUri = FileProvider.getUriForFile(v.getContext(), "com.teesteknoloji.contractanalysis.provider", toOpen);
